...
class evaluation():
    ...
    @staticmethod
    def eval_L2(frequency:list, amplitude:list, axs, uncertainty_frequency, uncertainty_amplitude, beta0, test_phase = False):
        odr_model = odr.Model(Fit_Functions_L2.fit_func_odr)
        data = odr.RealData(frequency, amplitude, sx = uncertainty_frequency, sy = uncertainty_amplitude)
        odr_fit = odr.ODR(data,odr_model, beta0 = beta0, maxit = 100)
        output = odr_fit.run()
        ...
        y = [Fit_Functions_L2.fit_func_odr([a, omega_0, delta, B, C], i) for i in x]
        ...
        amplitude_res_freq = Fit_Functions_L2.fit_func_odr([a, omega_0, delta, B, C], resonance_frequency)
        ...
        func = lambda omega, a, omega_0, delta, B, C: Fit_Functions_L2.fit_func_odr([a, omega_0, delta, B, C], omega) - amplitude_cut_off_freq
